                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach items="${products.dtoList}" var="product">
                            <li>
                                <a href="/product/detail/${product.productId}" style="color: black; text-decoration: none;">
                                    <div class="card">
                                        <img src="/images/${product.productImgUrl}" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <p class="card-text">${product.productName}</p>
                                            <div style="font-size: 0.9rem"><strong>가격: <fmt:formatNumber value="${product.price}" pattern="#,###,###"/>원</strong></div>
                                        </div>
                                    </div>
                                </a>
                            </li>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                <c:forEach items="${products.pageList}" var="pageList">
                    <li class="page-item"><a class="page-link" href="<c:url value="/category/bottom?page=${pageList}"/>">${pageList}</a></li>
                </c:forEach>
